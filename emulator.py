...
def create_MESA_population(nstars=1, fk=7.5, rocrit=1.6, plot=True, save_dataframe=False,
...
def create_YREC_population(nstars=1, fk=7.5, rocrit=1.6, plot=True, save_dataframe=False,
